...
public class Controller extends HttpServlet {
	...
	public void init() throws ServletException {
        ...
        Action.add(new ShowStyleAction(model));
        Action.add(new DesignAction());
        Action.add(new LikeAction(model));
        Action.add(new CollectionsAction(model));
        Action.add(new LatestAction(model));
        Action.add(new IndexAction(model));
        Action.add(new SaveAction(model));
        Action.add(new SearchImgAction(model));
        Action.add(new ProfileAction(model));
        Action.add(new ShowLikeAction(model));
